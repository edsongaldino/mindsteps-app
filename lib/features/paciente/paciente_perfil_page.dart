                        ...
                        child: SingleChildScrollView(
                          child: Column(
                            ...
                            children: [
                              ...
                              SizedBox(height: 12),
                              Text(
                                'Se você está enfrentando problemas técnicos com o aplicativo, tem dúvidas sobre como registrar seus pensamentos ou realizar o check-in emocional, nossa equipe está pronta para ajudar.',
                                style: TextStyle(fontSize: 14, color: AppColors.muted, height: 1.5),
                              ),
                              SizedBox(height: 20),
                              Text(
                              ...
                              Row(
                                children: [
                                  ...
                                  SizedBox(width: 8),
                                  Text('suporte@mindsteps.com.br', style: TextStyle(fontSize: 14, color: AppColors.text)),
                                ],
                              ),
                              SizedBox(height: 8),
                              Row(
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                buildBulletPoint('Seu acesso ao MindSteps será removido;'),
                                const SizedBox(height: 6),
                                buildBulletPoint('Seu histórico de atividades será apagado;'),
                                const SizedBox(height: 6),
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          const Expanded(
                            child: Text(
                              'Seus dados poderão ser mantidos pela clínica ou psicólogo responsável conforme obrigações legais e éticas da prática profissional.',
                              style: TextStyle(
                                fontSize: 13,
